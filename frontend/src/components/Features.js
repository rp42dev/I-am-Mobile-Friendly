...
const Features = () => {
    return (
        ...
        <div className="container mx-auto flex-wrap items-center justify-center gap-8 text-center sm:flex">
            <div className="w-full px-4 py-4 mt-6 rounded-lg shadow-xl sm:w-1/2 md:w-1/2 lg:w-1/4 bg-base-200">
                <div className="flex-shrink-0">
                    <div className="flex items-center justify-center w-12 h-12 mx-auto text-white bg-accent rounded-md">
            ...
            <div className="w-full px-4 py-4 mt-6 rounded-lg shadow-xl sm:w-1/2 md:w-1/2 lg:w-1/4 lg:mt-24 bg-base-200">
                <div className="flex-shrink-0">
                    <div className="flex items-center justify-center w-12 h-12 mx-auto text-white bg-accent rounded-md">
