...
const ProblemSolution = (props) => {
    ...
    return (
        <section id="problem" className="px-6 lg:px-0 container relative mx-auto bg-base-200 rounded-md shadow-xl py-24 mb-20">

            <div className="relative px-4 sm:px-6 lg:px-12 xl:px-16">
                <div className="flex flex-wrap content-center">
                    <div className="w-full px-4 lg:w-1/2">
                        <div className="relative space-y-4">
                            <h4 className="text-2xl font-extrabold sm:text-4xl">
                                {data[0].text}
                            </h4>
